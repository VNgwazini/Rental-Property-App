...
`;
const AutosizeInput = React.memo(React.forwardRef(({ id, onBlur, onFocus, readOnly, required, onChange, ariaLabel, inputValue, addClassNames, ariaLabelledBy, selectedOption }, ref) => {
